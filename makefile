...
prog: main.o coul-fct1_2.o victoire.o grille.o fonctions_utiles.o couleur.o
	gcc -Wall -Wextra main.o coul-fct1_2.o victoire.o grille.o fonctions_utiles.o couleur.o -o prog -lm
main.o: main.c grille.h coul-fct1_2.h victoire.h fonctions_utiles.h
...
couleur.o: couleur.c couleur.h
	gcc -Wall -Wextra -c couleur.c -lm
